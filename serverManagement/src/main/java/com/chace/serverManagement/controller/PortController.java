...
@RequestMapping(path = "api/v2/port")  /* used to map the web requests */
...
public class PortController {
  ...
  public ResponseEntity<ResponseStructure> getPortsList() {
    return ResponseEntity.ok(
        ResponseStructure.builder()
            ...
            .data(Map.of("ports", serverService.portsList(PAGE_INDEX, PAGE_SIZE)))
            .build());
  }
